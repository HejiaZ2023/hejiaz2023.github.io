...
This is Hejia Zhang, a 1st-year MS student in Computer Engineering at UCSD, California. I'm current doing [MLsys](https://mlsys-ucsd.org/) related research advised by Prof. [Jishen Zhao](https://cseweb.ucsd.edu/~jzhao/).

My current research interests include:
1. Improving performance and efficiency of LLM coding agents;
2. LLM for better EDA design.
...
Publications
------
[**MAGE: A Multi-Agent Engine for Automated RTL Code Generation**](https://arxiv.org/abs/2412.07822)  
Yujie Zhao\*, **Hejia Zhang\***, Hanxian Huang, Zhongming Yu, Jishen Zhao  
*Accepted by the 62th ACM/IEEE Design Automation Conference (DAC), 2025*  
